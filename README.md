...
- [Java](https://github.com/june2/banking-app/tree/master/backend-java)
  ...
  - 기능 구현 범위
    - [x]  REST API 구축
    - [x]  앱구동시 csv파일 db에 적재 : https://github.com/june2/banking-app/blob/44d7cd3ee3b1f398cd8dd4fe72e08ec11c3ac1ab/backend-java/src/main/java/com/banking/common/Banking.java#L1-L99
    - [x]  swagger
    - [x]  unit test
    - [ ]  2019년 예측 api
    - [x]  JWT 인증 구현
